...
| [`deep-research-answer`](skills/deep-research-answer/SKILL.md) | Reach a multi-source-verified answer to one question, verdict first (YES, NO, or NOT A YES/NO QUESTION), with verification status, confidence, assumptions, and source footnotes. | `deep-research` | — |
