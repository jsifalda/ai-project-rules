# Vendor thermo-nuclear-code-review skill

- Added `skills/thermo-nuclear-code-review/` (SKILL.md + references/code-smells.md), vendored from intercom/2x-skills (MIT).
