...
- Load `references/scoring-rubric.md`. Score every shortlisted candidate on its weighted dimensions, apply the hard-constraint disqualification rule, rank the candidates, and pick one winner.
