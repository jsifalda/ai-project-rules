...
| [`thermo-nuclear-code-review`](skills/thermo-nuclear-code-review/SKILL.md) | Strict single-axis structural/architectural review of a diff or branch — hunts "code judo" moves that delete whole branches, layers, or abstractions, scored against Fowler smells and 9 non-negotiable standards. Not a correctness, style, or security review. | — |
