...
| [`break-into-tasks`](skills/break-into-tasks/SKILL.md) | Break one task into ridiculously small, atomic steps of under a minute each, ending with the exact first move and where to put your hands. Refuses to run without a task, and sharpens a vague one through an interview before splitting. | `grill-me` | — |
