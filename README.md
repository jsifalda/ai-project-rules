...
| [`setup-todo-backlog`](skills/setup-todo-backlog/SKILL.md) | Bootstrap a known-issues backlog in any project — `docs/TODO.md` with dated immutable ids, optional conversion of an existing checklist, and a two-way end-of-session sweep policy injected into AGENTS.md/CLAUDE.md. | — | — |
