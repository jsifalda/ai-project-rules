...
| [`i-have-adhd`](skills/i-have-adhd/SKILL.md) | Reshape every response for an ADHD reader — action first, numbered steps, restated state, concrete time estimates, no preamble or closers. Manual-invoke only. | — | [ayghri/i-have-adhd](https://github.com/ayghri/i-have-adhd) |
